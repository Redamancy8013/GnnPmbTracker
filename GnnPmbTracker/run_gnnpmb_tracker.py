...
def parse_args():
    ...
    parser.add_argument('--detection_file',default='/home/ez/project/dataset/pointpillars/pointpillars_val.json', help='directory for the inference file')
    parser.add_argument('--programme_file', default='/home/ez/project/GnnPmbTracker')
    parser.add_argument('--dataset_file', default='/home/ez/project/dataset/nuscenes/')
    parser.add_argument('--parallel_process', default=1)
    parser.add_argument('--render_classes', default='car')
    parser.add_argument('--result_file', default='/home/ez/project/GnnPmbTracker')
...
def main(classification,token, out_file_directory_for_this_experiment):
    ...
    print('done with loading inference file')
...
if __name__ == '__main__':
    ...
    if arguments.data_version =='v1.0-trainval':
        ...
        raise KeyError('wrong data version')
    classifications = ['bicycle','pedestrian','car']
    ...
    for classification in classifications:
        print('start with {}'.format(classification))
        inputarguments=[]
